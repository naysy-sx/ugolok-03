...
6.7 (UI долей) — `[W]`, следующим шагом. Реализация читающей стороны
внутри `content.js`/`player-bridge.js` (плеер/миниатюры ВНУТРИ
смонтированной доли — сам UI-путь просмотра, не ключ) — не
