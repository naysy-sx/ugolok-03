...
// promise висел бесконечно, никакого срока не было вообще. 15с — компромисс
// из ТЗ (не лечить симптом увеличением таймаута, см. "Запрещённые починки" п.5 —
// это ИЗНАЧАЛЬНОЕ введение срока, не подгонка уже существующего).
const DEFAULT_PUBLISH_TIMEOUT_MS = 15000;
