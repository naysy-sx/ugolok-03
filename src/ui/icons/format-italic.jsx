// Radix Icons (radix-ui/icons, MIT license) — font-italic.svg, скопирована вручную из
// https://github.com/radix-ui/icons/blob/main/packages/radix-icons/icons/font-italic.svg
export default function IconFormatItalic(props) {
	return (
