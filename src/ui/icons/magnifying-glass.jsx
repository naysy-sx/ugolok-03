// "Открыть фото профиля" — hover-реveal на квадратном аватаре (VISUAL.md v2).
// Настоящий контур Radix Icons (MagnifyingGlassIcon, MIT) — проект юзает Radix.
export default function IconMagnifyingGlass(props) {
	return (
