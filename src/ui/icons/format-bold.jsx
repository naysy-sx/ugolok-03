// Radix Icons (radix-ui/icons, MIT license) — font-bold.svg, скопирована вручную из
// https://github.com/radix-ui/icons/blob/main/packages/radix-icons/icons/font-bold.svg
export default function IconFormatBold(props) {
	return (
