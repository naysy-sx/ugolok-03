// Список участников комнаты (quick.jsx) — Lets Icons by Leonid Tsvetkov
// (CC BY 4.0), взята у пользователя как есть.
export default function IconUserBadge(props) {
	return (
		<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" aria-hidden="true" class="icon" {...props}>
			<path
				fill="currentColor"
				fill-opacity=".25"
