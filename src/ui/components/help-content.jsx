...
// 12 языков × 6 тем = 72 файла, все бандлятся статически (?raw, тот же приём,
...
import podderzhkaRu from "../../content/help/ru/podderzhka.md?raw";
...
import podderzhkaEn from "../../content/help/en/podderzhka.md?raw";
...
import podderzhkaEs from "../../content/help/es/podderzhka.md?raw";
...
import podderzhkaDe from "../../content/help/de/podderzhka.md?raw";
...
import podderzhkaJa from "../../content/help/ja/podderzhka.md?raw";
...
import podderzhkaFr from "../../content/help/fr/podderzhka.md?raw";
...
import podderzhkaPt from "../../content/help/pt/podderzhka.md?raw";
...
import podderzhkaIt from "../../content/help/it/podderzhka.md?raw";
...
import podderzhkaNl from "../../content/help/nl/podderzhka.md?raw";
...
import podderzhkaPl from "../../content/help/pl/podderzhka.md?raw";
...
import podderzhkaTr from "../../content/help/tr/podderzhka.md?raw";
...
import podderzhkaZh from "../../content/help/zh/podderzhka.md?raw";

const HELP_CONTENT = {
	ru: { "o-proekte": oProekteRu, "kontakty-i-kanaly": kontaktyIKanalyRu, privatnost: privatnostRu, stek: stekRu, "iskhodnyj-kod": iskhodnyjKodRu, podderzhka: podderzhkaRu },
	en: { "o-proekte": oProekteEn, "kontakty-i-kanaly": kontaktyIKanalyEn, privatnost: privatnostEn, stek: stekEn, "iskhodnyj-kod": iskhodnyjKodEn, podderzhka: podderzhkaEn },
	es: { "o-proekte": oProekteEs, "kontakty-i-kanaly": kontaktyIKanalyEs, privatnost: privatnostEs, stek: stekEs, "iskhodnyj-kod": iskhodnyjKodEs, podderzhka: podderzhkaEs },
	de: { "o-proekte": oProekteDe, "kontakty-i-kanaly": kontaktyIKanalyDe, privatnost: privatnostDe, stek: stekDe, "iskhodnyj-kod": iskhodnyjKodDe, podderzhka: podderzhkaDe },
	ja: { "o-proekte": oProekteJa, "kontakty-i-kanaly": kontaktyIKanalyJa, privatnost: privatnostJa, stek: stekJa, "iskhodnyj-kod": iskhodnyjKodJa, podderzhka: podderzhkaJa },
	fr: { "o-proekte": oProekteFr, "kontakty-i-kanaly": kontaktyIKanalyFr, privatnost: privatnostFr, stek: stekFr, "iskhodnyj-kod": iskhodnyjKodFr, podderzhka: podderzhkaFr },
	pt: { "o-proekte": oProektePt, "kontakty-i-kanaly": kontaktyIKanalyPt, privatnost: privatnostPt, stek: stekPt, "iskhodnyj-kod": iskhodnyjKodPt, podderzhka: podderzhkaPt },
	it: { "o-proekte": oProekteIt, "kontakty-i-kanaly": kontaktyIKanalyIt, privatnost: privatnostIt, stek: stekIt, "iskhodnyj-kod": iskhodnyjKodIt, podderzhka: podderzhkaIt },
	nl: { "o-proekte": oProekteNl, "kontakty-i-kanaly": kontaktyIKanalyNl, privatnost: privatnostNl, stek: stekNl, "iskhodnyj-kod": iskhodnyjKodNl, podderzhka: podderzhkaNl },
	pl: { "o-proekte": oProektePl, "kontakty-i-kanaly": kontaktyIKanalyPl, privatnost: privatnostPl, stek: stekPl, "iskhodnyj-kod": iskhodnyjKodPl, podderzhka: podderzhkaPl },
	tr: { "o-proekte": oProekteTr, "kontakty-i-kanaly": kontaktyIKanalyTr, privatnost: privatnostTr, stek: stekTr, "iskhodnyj-kod": iskhodnyjKodTr, podderzhka: podderzhkaTr },
	zh: { "o-proekte": oProekteZh, "kontakty-i-kanaly": kontaktyIKanalyZh, privatnost: privatnostZh, stek: stekZh, "iskhodnyj-kod": iskhodnyjKodZh, podderzhka: podderzhkaZh },
};
...
const TOPIC_DEFS = [
	...
	{ id: "podderzhka", titleKey: "help.topics.podderzhka" },
];
