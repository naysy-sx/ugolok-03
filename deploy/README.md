...
- Сборка образов relay/blossom на darwin/arm64 **не** обязательна для этого скелета. Честный минимум — сервис `web` раздаёт статику.

Готовый рабочий Docker-бандл инстанса смотрите в `agent/compose/`, не здесь.
